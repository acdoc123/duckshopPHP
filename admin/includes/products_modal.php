  ...
  <div class="modal-dialog">
    <div class="modal-content rounded">
      <div class="modal-header">
        ...
        <h3 class="modal-title"><b><span class="name"></span></b></h3>
      </div>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content rounded">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span></button>
        <h3 class="modal-title"><b>Add New Product</b></h3>
      </div>
      <div class="modal-body">
        <form class="form-horizontal" method="POST" action="products_add.php" enctype="multipart/form-data">
          <div class="form-group">
            ...
            <div class="col-sm-5">
              <select class="form-control rounded" id="category" name="category" required>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-5">
              <input type="text" class="form-control rounded" id="price" name="price" required>
            </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-5">
              <input type="number" class="form-control rounded" id="stock" name="stock" min=0 required>
            </div>
          </div>
          <p><b>Description</b></p>
          <div class="form-group">
