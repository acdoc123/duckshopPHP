      ...
      <div class="modal-body">
        <form class="form-horizontal" method="POST" action="cart_add.php">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-9">
              <select class="form-control select2 rounded" style="width: 100%;" name="product" id="product" required>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-9">
              <input type="number" class="form-control rounded" id="quantity" name="quantity" value="1" required>
            </div>
          </div>
      </div>
