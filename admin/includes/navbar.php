<header class="main-header">
  ...
  <a href="#" class="logo">
    ...
    <span class="logo-mini color-1"><b>D</b>S</span>
    <!-- logo for regular state and mobile devices -->
    <span class="logo-lg color-1"><b>DuckShop</b></span>
  </a>
        ...
        <li class="dropdown user user-menu">
          ...
          <ul class="dropdown-menu">
            ...
            <li class="user-footer">
              <div class="pull-left">
                <a href="#profile" data-toggle="modal" class="btn btn-warning btn-flat rounded" id="admin_profile">Update</a>
              </div>
